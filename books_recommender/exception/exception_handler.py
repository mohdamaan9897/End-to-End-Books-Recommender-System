...
class AppException(Exception):
    """
    Organizaton: Mohd Amaan
    AppException is a customized exception class design to capture refined details about exception
    such as python script file line number along with error message
    With custom exception one can easily spot source o ferror and provide quick fix.
    """
